...
<html>
	...
	<body>
		...
		<div class="content">
			<div class="container">
				<div class="block">
					<br />Welcome! ${username} &nbsp;&nbsp; (Admin)<br /><br />
					<div class="module">
					...
					<div class="module">
						<a href="javascript:void(0);">
							<img src="web/images/expenses.png" width="150px" height="150px" />
							<br /> <span>Expenses</span>
						</a>
					</div>
					<div class="module">
						<a href="javascript:void(0);">
							<img src="web/images/reports.png" width="150px" height="150px" />
							<br /> <span>Reports</span>
						</a>
					</div>
					<div class="module">
						<a href="javascript:void(0);">
							<img src="web/images/suppliers.png" width="150px" height="150px" />
